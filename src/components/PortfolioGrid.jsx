...
import rec3Video from "../assets/rec3.webm";
import rec4Video from "../assets/rec4.mp4";
...
const PortfolioGrid = () => {
  ...
  const iphoneVideoSequence = ['rec4', 'rec3', 'rec1','rec2'];
    ...
    <section className="w-[80%] mx-auto mt-10 font-inter text-gray-300 ">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
        ...
        <div className="flex flex-col gap-6 ">
          ...
          {/* 1. iOS Mobile app section (Built to Flow Everywhere) - NOW FIRST */}
          <motion.div
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* 4. Comic Sketch Task Manager Project */}
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="flex items-center gap-4 bg-[#1B1B1B] mb-4">
              <a href="https://gymsamp.netlify.app/" className="max-w-[calc(100%-40px)] flex-grow group">
                <h3 className="text-lg text-gray-300 font-medium bg-[#1B1B1B] group-hover:text-orange-500 transition-colors duration-300">CULT FIT</h3>
                <p className="text-sm text-gray-500 bg-[#1B1B1B]">Interactive fitness website featuring advanced scroll-based animations and immersive UI effects. Built with React, Tailwind, and GSAP, it delivers a fully responsive, performance-optimized user experience.</p>
              </a>
              <a href="https://gymsamp.netlify.app/" className="flex-shrink-0 text-orange-500 hover:text-white transition-colors duration-300 ml-auto bg-[#1B1B1B]">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 bg-[#1B1B1B]">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15M19.5 4.5H8.25M19.5 4.5v11.25"/>
                </svg>
              </a>
            </div>
            <a href="https://gymsamp.netlify.app/" className="block">
              <div className="relative group w-full bg-[#1B1B1B] min-h-[180px] sm:min-h-[220px] flex items-center justify-center overflow-hidden">
                {/* Back Card - Gym 2 */}
                <LazyImage
                  src={gym2}
                  alt="CULT FIT - Back Card"
                  className="absolute w-[90%] h-[90%] object-contain rounded-xl z-0 transform-gpu rotate-[5deg] opacity-70 scale-[0.85] transition-all duration-500 ease-in-out group-hover:rotate-[20deg] group-hover:translate-x-[90px] group-hover:translate-y-[-20px] group-hover:scale-[1.15] group-hover:opacity-100 group-hover:z-10 group-hover:shadow-xl"
                />
                {/* Front Card - Gym 1 */}
                <LazyImage
                  src={gym1}
                  alt="CULT FIT - Front Card"
                  className="absolute w-full h-full object-contain rounded-xl z-10 transform-gpu transition-all duration-500 ease-in-out group-hover:rotate-[-20deg] group-hover:translate-x-[-40px] group-hover:translate-y-[-20px] group-hover:scale-[1.15] group-hover:shadow-xl"
                />
              </div>
            </a>
          </motion.div>
